...
export default function Home() {
  return (
    <section className="my-3 md:my-8 max-w-6xl md:mx-auto ">
      <div className="p-1 md:p-2  w-full flex flex-col md:flex-row gap-3">
       
        <div className="p-2 md:p-6 flex-1 cursor-pointer hover:scale-[1.03] duration-300 bg-gradient-to-r from-[#6FC3FF] via-[#4a9cd7] to-[#2b75dd]  rounded-2xl relative">
          <span className="text-white mb-6 capitalize font-semibold">
            More offers
          </span>
          <h1 className="text-[30px] md:text-[45px] lg:text-[50px] font-black text-shadow text-white md:w-[75%] lg:w-[70%] capitalize">
          ...
          <div className="h-[70px] md:h-[100px]">
            <Image
              src={airPods}
              alt="airPods Pic"
              className="Img w-[120px] md:w-[250px] absolute bottom-2 md:-bottom-10 right-4"
            />
          </div>
        </div>

        
        <div className="flex gap-1 h-[35vh] md:h-[97vh] lg:h-[87vh]  md:flex-col flex-row md:gap-0 md:basis-[45%]">

          
          <div className="flex-1  bg-gradient-to-r  from-violet-500 via-violet-700 to-indigo-800 p-1 md:p-6 md:mb-3 relative rounded-lg md:rounded-2xl  md:h-[47.5%] cursor-pointer hover:scale-[1.03] duration-300">
            <div className="flex justify-between items-center">
              <h1 className="text-white text-sm md:text-base font-semibold">My Cart</h1>
              <CgArrowTopRight className="text-white font-black text-base md:text-2xl" />
            </div>
            <Image
              src={Cart}
              alt="announce"
              className="w-[100%] md:w-[75%] Img absolute -translate-y-1/2 top-1/2 -right-5 md:-right-14"
            />
            <Link
              href="/cart"
              className="hover:text-black/80 absolute hover:-translate-y-2 duration-300 bottom-0 md:bottom-2 left-2 text-lg md:text-4xl text-shadow font-black text-white"
            >
              View Your Items
            </Link>
          </div>
          ...
          <div className="flex-1   md:h-[50%] flex flex-col md:flex-row gap-1 md:gap-3">
            ...
            <div className="bg-gradient-to-br from-violet-400 via-indigo-500 to-fuchsia-500 relative rounded-lg md:rounded-2xl p-1 md:p-4 flex-1 cursor-pointer hover:scale-[1.03] duration-300">
              <div className="flex justify-between items-center">
                ...
                <CgArrowTopRight className="text-white font-black text-lg md:text-2xl" />
              </div>
              <Image
                src={Contact}
                alt="Contact"
              ...
              <Link
                href="/contact"
                className="hover:text-black/80 absolute hover:-translate-y-2 duration-300 bottom-0 md:bottom-2 md:left-2  text-lg md:text-4xl text-shadow font-black text-white"
              >
                Contact
              </Link>
            </div>
