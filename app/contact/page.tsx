function Contact() {
  const input ='flex-1 border-red-500 px-2 md:px-4 py-2 outline-none border-b-4  bg-white rounded-tr-md rounded-tl-md   placeholder:text-slate-950/25  '
  ...
  return (
    <section className="my-5 md:my-8 w-full relative flex justify-start items-center ">
      <article className="w-[95%] md:w-[90%] lg:w-[80%]  mx-auto p-4 bg-blue-200/20 backdrop-blur-md rounded-xl border border-white/30">
        ...
        <form action="" className="my-5 w-full flex flex-col  gap-5 md:gap-8">
          ...
          <div className="flex  w-full  lg:w-[80%] lg:mx-auto ">
            <button
              type="submit"
              className="rounded-xl  text-white text-sm sm:text-lg font-black px-3 md:px-4 py-1.5 md:py-2 bg-red-500"
            >
              Send
            </button>
          </div>
      ...
      <div className="h-[150px] md:h-[250px] lg:h-[290px] w-[150px] md:w-[250px] lg:w-[290px] -z-20  rounded-full bg-red-600/50 absolute top-4 left-4"></div>
      <div className="h-[150px] md:h-[250px] lg:h-[290px] w-[150px] md:w-[250px] lg:w-[290px] -z-20  rounded-full bg-white/50 absolute bottom-4 right-4"></div>
    </section>
  );
}
