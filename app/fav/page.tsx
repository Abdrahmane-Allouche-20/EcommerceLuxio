...
import Love from '../../public/love-always-wins.png'
import Link from 'next/link'

import FavoriteList from './favoriteList';
import Image from 'next/image'
function Favorites() {
  const {favorites,finalPrice,handleCart,RemoveFavorite}=useAppContext();
  ...
  return (
    <div className='max-w-6xl mx-auto  rounded-lg my-2 md:my-4 p-2 md:p-4'>
      ...
      {favorites.length>0?favorites.map((favorite)=>(
        <FavoriteList key={favorite.id} finalPrice={finalPrice} favorite={favorite} handleCart={handleCart}  RemoveFavorite={RemoveFavorite}  />
      ))
      ...
      <div className=' col-span-1 md:col-span-2  '>
       ...
       <p>Add Some Product for Later Check</p>
        <Image src={Love} alt='add to favorite' className='md:w-[200px] w-[100px]'/>
        </Link>
